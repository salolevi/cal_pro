...
- **A · Bulk import** — Open Food Facts: free, open (CC-BY-SA), crowdsourced, with an Argentina subset filterable by country tag or by the 779 barcode prefix Argentina uses under the GS1 system. Immediate baseline coverage; treat it as a floor, not the final answer, since quality is uneven.
